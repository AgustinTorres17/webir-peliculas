...
function App() {
  ...
  window.addEventListener("scroll", () => {
    ...
    const carouselHomeContainer = document.querySelector("#carousel-homepage-container");
    ...
    if (window.scrollY > 10 && isTabletOrDesktop) {
      let newOpacity = window.scrollY / 500;
      if (newOpacity > 1) newOpacity = 1;
      setOpacity(newOpacity);
      if (!carouselHome.classList.contains("carousel"))
