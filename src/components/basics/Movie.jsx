  ...
  return (
    <div className="flex  flex-col lg:flex-row p-5 lg:justify-start w-full items-center">
      <div className="w-full flex gap-10 flex-col lg:flex-row justify-between items-center">
        <div className="flex h-96 items-start justify-start shadow-xl shadow-black/50 w-72 md:pt-2 hover:shadow-accent/50 hover:shadow-2xl transition-shadow duration-300">
          {movie.img ? (
            <img
              src={movie.img}
              alt="Movie logo"
